...
$pdf->text(47,31,'CALON SISWA BARU YANG DITOLAK TAHUN AJARAN '.$thajaran);
...
$ya = $yi + $row;
$sql = mysql_query("select * from  tbl_calonsiswa, tbl_jurusan, tbl_psbsetup where tbl_calonsiswa.f_jurusanid = tbl_jurusan.f_jurusanid and f_statusterima='TOLAK' ");
$i = 1;
$no = 1;
$max = 31;
$row = 6;
